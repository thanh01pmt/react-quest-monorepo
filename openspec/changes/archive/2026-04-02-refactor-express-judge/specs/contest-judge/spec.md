# Capability: Contest Judge

The contest judge system is responsible for evaluating participant submissions, calculating scores based on test cases, and updating the leaderboard.
