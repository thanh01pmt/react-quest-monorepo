...
class SymmetricalIslandsTopology(BaseTopology):
    ...
    def generate_path_info(self, grid_size: tuple, params: dict) -> PathInfo:
        ...
        islands_list: list[list[Coord]] = [] # [FIX] Collect individual islands for metadata
        ...
        for i in range(num_islands):
            ...
            islands_list.append(island_path) # [FIX] Store for metadata
        ...
        # [FIX] Populate metadata with islands structure
        metadata = {
            "islands": islands_list,
            "topology_type": "symmetrical_islands",
            "num_islands": num_islands,
            # [NEW] Semantic positions for island_replication strategy
            "semantic_positions": {
                'start': start_pos,
                'end': target_pos,
                'optimal_start': 'start',
        ...
        return PathInfo(
            ...
            placement_coords=all_path_coords,
            obstacles=[], # No explicit obstacles, rely on gaps
            metadata=metadata
        )